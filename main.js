...
/* Runs everytime the lone pairs are pressed (aka the dots) */
  ...
  function submit() {
    ...
    var gnames = ["tri-bi","tri-planar","linear","tetrahedral","octahedral", "square-planar", "square-pyramidal", "see-saw", "t-shaped"];
    var gnames_new = ["Trigonal bipyramidal",
    "Triagonal planar",
    "Linear",
    "Tetrahedral",
    "Octahedral",
